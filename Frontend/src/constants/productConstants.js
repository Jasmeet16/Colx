...
export const  PRODUCT_BYUSER_REQUEST = 'PRODUCT_BYUSER_REQUEST'
export const PRODUCT_BYUSER_SUCCESS = 'PRODUCT_BYUSER_SUCCESS'
export const PRODUCT_BYUSER_FAIL = 'PRODUCT_BYUSER_FAIL'
